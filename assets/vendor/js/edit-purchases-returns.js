  ...
  $('#add-table-purchases').on('click', '.add-purchases', function () {
     ...
     <td></td>
                       <td>  
                                 ...
                                 <td>  
                                   <select  class="form-select select2 form-control"  data-allow-clear="true">
                                     <option value="AK" selected>   	اختر الصنف</option>
                                     <option value="HI">1</option>
                                     <option value="CA">1</option>
                                     <option value="NV">1</option>
                                     <option value="OR">1</option>
                                 ...
                                 <td style="width: 30%;">
                                   ...
                                   <td style="width: 60%;">
                                   <select class="select2 form-select" data-allow-clear="true">
                                     <option value="AK" selected>اسم الرف</option>
                                     <option value="HI">1</option>
                                     <option value="CA">1</option>
                                     <option value="NV">1</option>
                                     <option value="OR">1</option>
                                 ...
                                 <td style="width: 10%;"><input type="number"class="form-control"></td>
                                 <td style="width: 10%;"><input type="date"class="form-control"></td>
                                 <td style="width: 10%;"><input type="date"class="form-control"></td>
