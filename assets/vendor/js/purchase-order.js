$(document).ready(function () {
     ...
     $('#my-table-order').on('click', '.btnaddorder', function () {
       const newRow = `
         <tr>
           <td>${$('#my-table-order tbody tr').length + 1}</td>
           <td>
       ...
       $('#my-table-order tbody').append(newRow);
     ...
     $('#my-table-order').on('click', '.btn-delete', function () {
       $(this).closest('tr').remove(); // Remove the row
   
       // Update the row numbering
       $('#my-table-order tbody tr').each(function (index) {
       ...
       $('#my-table-edit').on('click', '.btnaddvalueedit', function () {
        const newRow = `
          ...
          <td>
                            ...
                            <td style="width: 20%;"> <input type="number" class="form-control"></td>
            <td class="d-flex justify-content-center align-items-center">
