...
function updateRowNumbersee() {
    $('#my-table-purchases tr').each(function (index, row) {
        $(row).find('td:first').text(index + 0); // الترقيم يبدأ من 1
    });
}
//table-Perished
 // Add new row when plus button is clicked
 $('#my-table-purchases').on('click', '.add-purchases', function () {
    var newRowe = `
    <tr>
    <td></td>
 <td>  
